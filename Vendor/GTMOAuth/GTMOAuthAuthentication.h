...
_EXTERN NSString* const kGTMOAuthWebViewStartedLoading _INITIALIZE_AS(@"kGTMOAuthWebViewStartedLoading");
_EXTERN NSString* const kGTMOAuthWebViewStoppedLoading _INITIALIZE_AS(@"kGTMOAuthWebViewStoppedLoading");
_EXTERN NSString* const kGTMOAuthWebViewKey            _INITIALIZE_AS(@"kGTMOAuthWebViewKey");
_EXTERN NSString* const kGTMOAuthWebViewStopKindKey    _INITIALIZE_AS(@"kGTMOAuthWebViewStopKindKey");
_EXTERN NSString* const kGTMOAuthWebViewFinished       _INITIALIZE_AS(@"finished");
